 ...
 * @author MyPC
 */
public class TK_Product extends javax.swing.JFrame {

    /**
     * Creates new form TK_Product
     */
    public TK_Product() {
        ...
        jcontent.removeAll();
        jcontent.add(frm, "Thống kê loại mặt hàng");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Product.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TK_Product().setVisible(true);
            }
        });
    }
