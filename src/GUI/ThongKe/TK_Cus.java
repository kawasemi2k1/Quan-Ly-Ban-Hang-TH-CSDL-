 ...
 * @author MyPC
 */
public class TK_Cus extends javax.swing.JFrame {

    /**
     * Creates new form TK_Cus
     */
    public TK_Cus() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Cus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
