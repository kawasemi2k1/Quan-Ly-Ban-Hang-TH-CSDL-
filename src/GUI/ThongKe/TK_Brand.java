 ...
 * @author MyPC
 */
public class TK_Brand extends javax.swing.JFrame {

    /**
     * Creates new form TK_Brand
     */
    public TK_Brand() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Brand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
