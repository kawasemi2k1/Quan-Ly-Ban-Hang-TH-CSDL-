 ...
 * @author MyPC
 */
public class TK_Staff extends javax.swing.JFrame {

    /**
     * Creates new form TK_Staff
     */
    public TK_Staff() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Staff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
