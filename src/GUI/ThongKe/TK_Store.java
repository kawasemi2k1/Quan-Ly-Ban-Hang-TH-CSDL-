 ...
 * @author MyPC
 */
public class TK_Store extends javax.swing.JFrame {

    /**
     * Creates new form TK_Store
     */
    public TK_Store() {
       this.setAlwaysOnTop(true); // this interface is always on top
        ...
        jcontent.removeAll();
        jcontent.add(frm, "Thống kê theo các cửa hàng");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Store.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
