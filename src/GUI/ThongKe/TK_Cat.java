 ...
 * @author MyPC
 */
public class TK_Cat extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Cat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
