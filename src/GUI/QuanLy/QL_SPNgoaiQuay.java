 ...
 * @author MyPC
 */
public class QL_SPNgoaiQuay extends javax.swing.JFrame {

    /**
     * Creates new form QL_SPNgoaiQuay
     */
    public QL_SPNgoaiQuay() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QL_SPNgoaiQuay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QL_SPNgoaiQuay().setVisible(true);
            }
        });
    }
